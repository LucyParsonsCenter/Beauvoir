class PostsController < ApplicationController
  ...
  def hack_out_params
    begin
      params[:post][:post_title_links_attributes].each do |k,v| 
        params[:post][:post_title_links_attributes][k].delete :title
      end
    rescue
    end

    begin
      params[:post][:post_title_list_links_attributes].each do |k,v| 
        params[:post][:post_title_list_links_attributes][k].delete :title_list
      end
    rescue
    end
  end

...
ActiveRecord::Schema.define(version: 20151117024731) do
  ...
  add_index "invoice_line_items", ["purchase_order_line_item_id"], name: "index_invoice_line_items_on_purchase_order_line_item_id", using: :btree
